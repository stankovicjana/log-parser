...
public class Pointer {
    ...
    public static final Pointer createConstant(int peer) {
        return new Opaque((long)peer & 0xFFFFFFFFL, null);
    }
    ...
    Object getValue(long offset, Class<?> type, Object currentValue) {
        ...
        if (Structure.class.isAssignableFrom(type)) {
            ...
            if (Structure.ByReference.class.isAssignableFrom(type)) {
                s = Structure.updateStructureByReference(type, (Structure)s, (Pointer)this.getPointer(offset));
            } else {
            ...
            if (fp == null) {
                ...
                Pointer oldfp = CallbackReference.getFunctionPointer((Callback)cb);
                if (!fp.equals(oldfp)) {
                    cb = CallbackReference.getCallback(type, (Pointer)fp);
                }
                result = cb;
            }
    ...
    private void readArray(long offset, Object o, Class<?> cls) {
        int length = 0;
        length = Array.getLength((Object)o);
        Object result = o;
        if (cls == Byte.TYPE) {
            ...
            if (Structure.ByReference.class.isAssignableFrom(cls)) {
                ...
                for (int i = 0; i < sarray.length; ++i) {
                    sarray[i] = Structure.updateStructureByReference(cls, (Structure)sarray[i], (Pointer)parray[i]);
                }
            } else {
                Structure first = sarray[0];
                if (first == null) {
                    first = Structure.newInstance(cls, (Pointer)this.share(offset));
    ...
    public Pointer[] getPointerArray(long offset) {
        ...
        return (Pointer[])array.toArray((Object[])new Pointer[0]);
    }
    ...
    public String[] getStringArray(long offset, int length, String encoding) {
        ...
        if (length != -1) {
            ...
            int count = 0;
            while (count++ < length) {
                String s = p == null ? null : ("--WIDE-STRING--".equals((Object)encoding) ? p.getWideString(0L) : p.getString(0L, encoding));
                strings.add(s);
            ...
            while ((p = this.getPointer(offset + (long)addOffset)) != null) {
                String s = "--WIDE-STRING--".equals((Object)encoding) ? p.getWideString(0L) : p.getString(0L, encoding);
    ...
    void setValue(long offset, Object value, Class<?> type) {
        if (type == Boolean.TYPE || type == Boolean.class) {
            ...
            this.setPointer(offset, CallbackReference.getFunctionPointer((Callback)((Callback)value)));
        } else if (Platform.HAS_BUFFERS && Buffer.class.isAssignableFrom(type)) {
    ...
    private void writeArray(long offset, Object value, Class<?> cls) {
        if (cls == Byte.TYPE) {
            ...
            if (Structure.ByReference.class.isAssignableFrom(cls)) {
                ...
                if (first == null) {
                    sbuf[0] = first = Structure.newInstance(cls, (Pointer)this.share(offset));
                } else {
                    first.useMemory(this, (int)offset, true);
                }
                first.write();
            ...
            for (int i = 0; i < buf.length; ++i) {
                Object element = tc.toNative((Object)buf[i], new ToNativeContext());
    ...
    public String dump(long offset, int size) {
        ...
        PrintWriter out = new PrintWriter((Writer)sw);
        ...
        for (int i = 0; i < size; ++i) {
            ...
            out.print(Integer.toHexString((int)(b & 0xFF)));
    ...
    public String toString() {
        return "native@0x" + Long.toHexString((long)this.peer);
    }
